...
<body>
  ...
  $result = $PDO->PDO->query("SELECT * FROM `audios`");
...
<button class="add popup_link" href="#popupaddaudio">Добавить</button>
...
<div class="conteiner_tovar">
        ...
        <div class="tovar product" data-id="<?=$product['id']?>">
            ...
            <span class="tovar_text_har">
                (Формат звуковой схемы: <span><?=$product['format']?></span>, Тип конструкции: <span><?=$product['types']?></span>, Частота звука: <span><?=$product['mg']?></span>)
            </span>
            ...
            <a class="upravlenie" href="del_audio.php?del_id= <?= $product['id'] ?>">Удалить</a>
