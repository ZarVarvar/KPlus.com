<?php
            ...
            $result = $PDO->PDO->query("INSERT INTO `computers`(`id_cat`, `id_podcat`,`name`, `proc`, `video`, `ozu`, `oc`, `hddssd`, `price`, `img`) VALUES (0,0,'$name', '$proc', '$video', '$ozu', '$oc', '$hddssd', '$price', '/img/computer.svg')");
