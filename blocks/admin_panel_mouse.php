...
<body>
  ...
  $result = $PDO->PDO->query("SELECT * FROM `mouses`");
...
<button class="add popup_link" href="#popupaddmouse">Добавить</button>
...
<div class="conteiner_tovar">
        ...
        <div class="tovar product" data-id="<?=$product['id']?>">
            ...
            <span class="tovar_text_har">
                (Разрешение датчика: <span><?=$product['datch']?></span>, Сенсор: <span><?=$product['sensor']?></span>, Количество кнопок: <span><?=$product['count']?></span>)
            </span>
            ...
            <a class="upravlenie" href="del_mouse.php?del_id= <?= $product['id'] ?>">Удалить</a>
