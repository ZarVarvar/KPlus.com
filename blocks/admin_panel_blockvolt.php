...
<body>
  ...
  $result = $PDO->PDO->query("SELECT * FROM `blocks`");
...
<button class="add popup_link" href="#popupaddblockvolt">Добавить</button>
...
<div class="conteiner_tovar">
        ...
        <div class="tovar product" data-id="<?=$product['id']?>">
            ...
            <span class="tovar_text_har">
                (Мощность: <span><?=$product['volt']?></span>)
            </span>
            ...
            <a class="upravlenie" href="del_blockvolt.php?del_id= <?= $product['id'] ?>">Удалить</a>
