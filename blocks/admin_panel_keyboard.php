...
<body>
  ...
  $result = $PDO->PDO->query("SELECT * FROM `keyboards`");
...
<button class="add popup_link" href="#popupaddkeyboard">Добавить</button>
...
<div class="conteiner_tovar">
        ...
        <div class="tovar product" data-id="<?=$product['id']?>">
            ...
            <span class="tovar_text_har">
                (Тип клавиатуры: <span><?=$product['types']?></span>, Цвет подсветки клавиш: <span><?=$product['RGB']?></span>, Интерфейс подключения: <span><?=$product['interface']?></span>)
            </span>
            ...
            <a class="upravlenie" href="del_keyboard.php?del_id= <?= $product['id'] ?>">Удалить</a>
