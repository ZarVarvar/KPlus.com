...
<body>
  ...
  $result = $PDO->PDO->query("SELECT * FROM `hddssd`");
...
<button class="add popup_link" href="#popupaddhddssd">Добавить</button>
...
<div class="conteiner_tovar">
        ...
        <div class="tovar product" data-id="<?=$product['id']?>">
            ...
            <span class="tovar_text_har">
                (Объем: <span><?=$product['razmer']?></span>, Чтение: <span><?=$product['readd']?></span>, Запись: <span><?=$product['writee']?></span> )
            </span>
            ...
            <a class="upravlenie" href="del_hddssd.php?del_id= <?= $product['id'] ?>">Удалить</a>
