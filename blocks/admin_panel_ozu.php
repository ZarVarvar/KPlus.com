...
<body>
  ...
  $result = $PDO->PDO->query("SELECT * FROM `ozu`");
...
<button class="add popup_link" href="#popupaddozu">Добавить</button>
...
<div class="conteiner_tovar">
        ...
        <div class="tovar product" data-id="<?=$product['id']?>">
            ...
            <span class="tovar_text_har">
                (Объем памяти: <span><?=$product['ram']?></span>, Тактовая частота: <span><?=$product['tact']?></span>, Производитель: <span><?=$product['made']?></span>, Тайминги:
            ...
            <a class="upravlenie" href="del_ozu.php?del_id= <?= $product['id'] ?>">Удалить</a>
