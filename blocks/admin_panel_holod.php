...
<body>
  ...
  $result = $PDO->PDO->query("SELECT * FROM `holod`");
...
<button class="add popup_link" href="#popupaddholod">Добавить</button>
...
<div class="conteiner_tovar">
        ...
        <div class="tovar product" data-id="<?=$product['id']?>">
            ...
            <span class="tovar_text_har">
                (Основание: <span><?=$product['material']?></span>, Скорость вращения: <span><?=$product['speed']?></span>, Уровень шума: <span><?=$product['shum']?></span> )
            </span>
            ...
            <a class="upravlenie" href="del_holod.php?del_id= <?= $product['id'] ?>">Удалить</a>
