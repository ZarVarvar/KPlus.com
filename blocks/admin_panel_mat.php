...
<body>
  ...
  $result = $PDO->PDO->query("SELECT * FROM `mats`");
...
<button class="add popup_link" href="#popupaddmat">Добавить</button>
...
<div class="conteiner_tovar">
        ...
        <div class="tovar product" data-id="<?=$product['id']?>">
            ...
            <span class="tovar_text_har">
                (Сокет: <span><?=$product['socket']?></span>, ОЗУ: <span><?=$product['ozu']?></span>, Чипсет:
                <span><?=$product['chipset']?></span>, Аудио: <span><?=$product['audio']?></span>, Форма-фактор:
            ...
            <a class="upravlenie" href="del_mat.php?del_id= <?= $product['id'] ?>">Удалить</a>
